...
import { ChatSummary,
  ...
  GetChatMessagesQuery } from '../../structures/chats.dto';
...
//import { MessageId } from 'whatsapp-web.js'; @mahen
...
export abstract class WhatsappSession {
  ...
  //protected deserializeId(messageId: string): MessageId { @mahen
  protected deserializeId(messageId: string) {
